...
def train():
    ...
    data_gen_train = get_anchor_gt(train_data, label_dict, vn.get_img_output_length, mode='train')
    data_gen_val = get_anchor_gt(val_data, label_dict, vn.get_img_output_length, mode='val')
